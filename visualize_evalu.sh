...
python demo/pcd_demo.py /workspace/data/kitti_detection/kitti/testing/velodyne_reduced/000003.bin /workspace/mmdetection3d/working_dir/intensityAware_35pnt/intensityNetKitti_all_objects.py /workspace/mmdetection3d/working_dir/intensityAware_35pnt/epoch_80.pth --show --out-dir ./working_dir/IVEF
