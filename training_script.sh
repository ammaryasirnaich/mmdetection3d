...
CUDA_VISIBLE_DEVICES=1 python  tools/train.py /import/digitreasure/ammar_workspace/mmdetection3d/configs/3dconvit/convit3D_pointNet_transformer_nusence.py
