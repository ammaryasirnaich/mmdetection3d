...
# python tools/train.py /home/naich/workspace/mmdet3d/mmdetection3d/configs/3dconvit/experiments/pointconvit3d_kitti_experiments.py

# python tools/train.py /home/naich/workspace/mmdet3d/mmdetection3d/configs/3dconvit/pointconvit3d_kitti_config.py
python tools/train.py /home/naich/workspace/mmdet3d/mmdetection3d/configs/3dconvit/convit3D_pointNet_transformer_ssdhead_kitti_3x.py
