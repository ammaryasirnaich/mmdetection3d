...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_predict_depth=dict(type='FocalLoss', use_sigmoid=True, gamma=2, alpha=0.25, reduction='mean', loss_weight=3.0),
...
work_dir = './work_dirs/camera_branch'
