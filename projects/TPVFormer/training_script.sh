CONFIG_FILE="/import/digitreasure/ammar_workspace/open_mmlab/mmdetection3d/projects/TPVFormer/configs/tpvformer_8xb1-2x_nus-seg.py"
...
TORCH_NCCL_BLOCKING_WAIT=1 NCCL_TIMEOUT=7200 CUDA_VISIBLE_DEVICES=0,1 PORT=29501 ../../tools/dist_train.sh ${CONFIG_FILE} ${GPU_NUM}
