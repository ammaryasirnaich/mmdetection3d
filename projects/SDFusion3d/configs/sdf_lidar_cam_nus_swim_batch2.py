...
log_level = 'INFO'
work_dir = './work_dirs/SHFusion_swing_num_initweight_deform_layers_batch2'
load_from = None
resume = True
resume_from = './work_dirs/SHFusion_swing_num_initweight_deform_layers_batch2'
workflow = [('train', 1)]  
