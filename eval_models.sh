...
CONFIG_FILE="/home/naich/workspace/mmdet3d/mmdetection3d/outputs/pointconvit_plan_improvements/pointconvit3d_kitti_plan_improvements.py"
# Copy epoch_100.pth from your training run (e.g. output_pointconvit3d_kitti/) into the path below if needed
CKPT_PATH="/home/naich/workspace/mmdet3d/mmdetection3d/outputs/pointconvit_plan_improvements/epoch_100.pth"
