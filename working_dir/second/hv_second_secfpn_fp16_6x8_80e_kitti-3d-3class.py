...
db_sampler = dict(
    data_root='/workspace/data/kitti/',
    info_path='/workspace/data/kitti/kitti_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='KittiDataset',
            data_root='/workspace/data/kitti/',
            ann_file='/workspace/data/kitti/kitti_infos_train.pkl',
            split='training',
            ...
            pipeline=[
                ...
                dict(
                    ...
                    db_sampler=dict(
                        data_root='/workspace/data/kitti/',
                        info_path=
                        '/workspace/data/kitti/kitti_dbinfos_train.pkl',
                        rate=1.0,
                        prepare=dict(
                            filter_by_difficulty=[-1],
    ...
    val=dict(
        type='KittiDataset',
        data_root='/workspace/data/kitti/',
        ann_file='/workspace/data/kitti/kitti_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
        pipeline=[
            dict(
...
log_level = 'INFO'
work_dir = './work_dirs/hv_second_secfpn_fp16_6x8_80e_kitti-3d-3class'
load_from = None
resume_from = None
workflow = [('train', 1)]
